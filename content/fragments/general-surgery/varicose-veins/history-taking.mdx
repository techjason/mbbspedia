...
- **CEAP classification** — you don't need to formally classify, but your history questions should naturally stage the patient (C1 = spider veins → C6 = active ulcer). This shows the examiner you understand severity grading.
