...
flowchart TD
    ...
    D --> D2["Skin changes of CVI: CEAP clinical class incl. C4c"]
...
### 3. Corona Phlebectatica (Ankle Flare; CEAP C4c)

- ***Fan-shaped pattern of small intradermal veins beneath the lateral and/or medial malleoli*** [1][2]
- ***CEAP C4c in the 2020 update*** — this is an early sign of **advanced** venous disease, showing venous hypertension has been transmitted to the distal microvasculature
...
| C4c | ***Corona phlebectatica*** | Fan-shaped ankle flare beneath/around the malleoli; a sign of advanced venous disease rather than simple C1 telangiectasia |
...
6. **Not mentioning the CEAP classification** — examiners love this. At minimum, know the ladder from C1 to C6 and remember that **corona phlebectatica is C4c**.
...
- **Corona phlebectatica is CEAP C4c** and an early sign of advanced venous disease — mentioning it shows you know the CEAP grading beyond the basics [1][2].
...
>
> *In summary, Mrs Chan has right-sided great saphenous vein varicose veins with clinical evidence of chronic venous insufficiency — CEAP class C4b disease, with additional corona phlebectatica (C4c) at the ankle. The saphenofemoral junction is incompetent. Deep venous system appears patent. Peripheral arterial pulses are intact. I would recommend a venous duplex ultrasound to confirm the clinical findings and define the anatomy prior to planning definitive management."*
...
2. **Inspect**: Anterior + posterior; identify distribution (GSV vs SSV); grade CVI using CEAP (remember `C4c = corona phlebectatica`)
...
<ActiveRecallQuiz
  ...
  items={[
    ...
    },
    {
      ...
      markscheme: "A fan-shaped pattern of small intradermal veins beneath the medial or lateral malleoli. In the updated CEAP classification this is C4c, and it is an early sign of advanced chronic venous disease indicating venous hypertension has been transmitted to the distal microvasculature.",
    },
    {
