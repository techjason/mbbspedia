...
|---------|------------|-----------|
| ***Metronidazole AND cephalosporin*** [4] | e.g., IV metronidazole 500 mg TDS + IV cefuroxime/ceftriaxone per local policy | Metronidazole ("metro" = covers anaerobes, especially *Bacteroides fragilis*; also has anti-protozoal activity). Cefuroxime/ceftriaxone covers common community Enterobacterales such as *E. coli* and *Klebsiella*; **ceftriaxone is not an anti-pseudomonal agent** |
  ...
  items={[
    {
      ...
      markscheme: "IV metronidazole + cephalosporin per local policy (e.g., cefuroxime or ceftriaxone). Metronidazole covers anaerobes (especially Bacteroides fragilis). The cephalosporin covers common community Enterobacterales such as E. coli and Klebsiella; ceftriaxone is not anti-pseudomonal. Given within 60-min window before incision. Non-complicated: 24h post-op. Complicated: 3-7 days post-op.",
    },
    {
