...
- ***IV antibiotics***: empirical coverage for enteric gram-negative aerobes, enterococci, and anaerobes [4][12]:
  - ***Augmentin (amoxicillin-clavulanate)*** — first-line for mild/moderate [2][12]
  - ***Tazocin (piperacillin-tazobactam)*** — for severe infection or if Augmentin is inadequate [2][12]
  - Alternatives: ***Cefuroxime + metronidazole***; severe infection may need ***meropenem + metronidazole*** [12]
...
##### Step 2: Antibiotics [2][4][12]
- ***IV Augmentin (mild)*** or ***IV Tazocin (severe)***; alternative ***cefuroxime + metronidazole***; severe sepsis/ESBL concern may need ***meropenem + metronidazole*** [12]
...
- ***ERCP is the preferred first-line drainage route when feasible*** [1]
...
| Step | Details |
|---|---|
| **IV antibiotics** | Empirical broad-spectrum antibiotics covering gram-negatives and anaerobes. IMPACT lists ***ceftriaxone + metronidazole*** as preferred for community-acquired liver abscess; alternatives include ***amoxicillin-clavulanate + metronidazole***, with ***meropenem + metronidazole*** for severe infection. Adjust based on blood/aspirate cultures. For *Klebsiella pneumoniae* liver abscess, assess for metastatic infection (especially endophthalmitis); ceftriaxone is preferred if CNS involvement is possible. [12] |
...
5. ***Cholangitis = RAD***: ***Resuscitation, Antibiotics (Augmentin mild / Tazocin severe; cefuroxime + metronidazole alternative; meropenem + metronidazole if severe/ESBL concern), Drainage (ERCP preferred 1st → PTBD 2nd → ECBD 3rd).***

6. ***Urgent drainage indications in cholangitis***: Reynolds' pentad, failure to respond to antibiotics within 24 h.

7. ***ERCP is the preferred first-line biliary drainage route when feasible*** — role in cholangitis is ***decompression first, NOT definitive stone clearance*** in the acute septic setting.
  ...
  items={[
    {
      ...
      markscheme: "R = Resuscitation (NPO, IV fluids, monitor vitals and I/O Q1h). A = Antibiotics (IV Augmentin for mild, IV Tazocin for severe; cefuroxime + metronidazole alternative; meropenem + metronidazole if severe/ESBL concern). D = Drainage (biliary decompression). Urgent drainage is indicated for: Reynolds' pentad (hypotension + confusion), failure to respond to antibiotics within 24 hours, clinical deterioration.",
    },
    {
...
[12] IMPACT 6th edition (2025): Part IV empirical therapy, biliary sepsis and community-acquired liver abscess
