...
| **Necrotising fasciitis (Fournier's gangrene)** | Life-threatening emergency → aggressive antibiotics + emergency surgical debridement | Current IMPACT-aligned empirical cover: ***IV meropenem + IV/PO linezolid*** with urgent microbiology/ID input and de-escalation after deep tissue cultures [14] |
...
- Common regimens:
  - **IV**: Amoxicillin-clavulanate (Augmentin) 1.2g TDS; piperacillin-tazobactam if severe/systemically septic; or cephalosporin + metronidazole per local policy
  - **Oral step-down**: Amoxicillin-clavulanate where susceptible/appropriate; reserve fluoroquinolone + metronidazole for situations where beta-lactam options are unsuitable and patient risk/susceptibility support use
...
- **Management**: Emergency surgical debridement (aggressive, wide, often requires multiple returns to theatre) + broad-spectrum IV antibiotics (IMPACT-aligned empirical regimen: meropenem + linezolid, with urgent microbiology/ID input) + ICU support + possible faecal diversion (defunctioning colostomy)
...
[14] IMPACT 6th edition (2025): Part IV empirical therapy, necrotising fasciitis
