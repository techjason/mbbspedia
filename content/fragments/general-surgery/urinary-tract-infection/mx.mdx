...
flowchart TD
    ...
    C1 --> C1a["Empirical oral Abx<br/>1st line: Nitrofurantoin 5d<br/>or Augmentin 5-7d<br/>Alt: cefpodoxime/cefuroxime/fosfomycin"]
    C1 --> C1b["General: fluids, pyridium<br/>No imaging needed"]
    
    C2 --> C2a["Longer Abx: 10-14d<br/>culture-guided<br/>(FQ only if susceptible)"]
    C2 --> C2b["Eradicate complicating feature"]
    
    D --> D1{"Severity?"}
    D1 -->|"Mild-moderate<br/>tolerating PO, stable"| D2["PO Abx if suitable<br/>guided by local resistance/CST<br/>avoid empiric FQ if possible"]
    ...
    E --> E1["Culture first; treat 2-6 weeks<br/>FQ only if appropriate/susceptible<br/>severe cases need IV cover then step-down"]
...
- ***Medical management (MM):***
  ...
  - ***Empirical Abx: broad IV cover as for severe pyelonephritis/sepsis — IV amoxicillin-clavulanate, piperacillin-tazobactam if Pseudomonas risk, or carbapenem if severe/ESBL risk — then narrow to C/ST***
...
***Mx: obtain urine/blood cultures, start empirical antibiotics promptly, then narrow to C/ST; total duration usually 2–6 weeks*** [4]

**Where do quinolones fit in prostatitis?**
...
- **Fluoroquinolones** are small, lipophilic molecules with excellent penetration across this barrier, so they remain useful for acute prostatitis when patient factors and susceptibility support use [10]
- This is **indication-specific**: the cystitis recommendation to avoid empirical FQ does not mean "never use FQ", but HK resistance and disabling adverse effects mean they should not be a reflex choice without culture review [8][10]
- **Co-trimoxazole/trimethoprim** penetrates the prostate but should be used only when susceptibility and G6PD status support it
- Severe/systemically unwell patients need admission, cultures, and initial IV therapy; step down to an oral agent once improving and sensitivities are known
...
| **Acute prostatitis** | Culture-guided therapy; FQ if appropriate/susceptible | Co-trimoxazole/trimethoprim if susceptible; IV beta-lactam-based therapy if severe | **2–6 weeks** | PO or IV then PO | Prostatic penetration matters, but review HK resistance/FQ safety |
| **EPN** | Broad IV severe UTI cover (amoxicillin-clavulanate → piperacillin-tazobactam if Pseudomonas risk → carbapenem if severe/ESBL risk) | Culture-guided | Prolonged | IV | ABC resuscitation; glycaemic control; PCD ± nephrectomy |
...
***Enterococcus is intrinsically resistant to cephalosporins and has low-level intrinsic aminoglycoside resistance.*** If your urine culture grows Enterococcus, do NOT treat with cefuroxime or ceftriaxone. Use ***Augmentin/amoxicillin or nitrofurantoin*** for susceptible lower-tract infection; ampicillin ± gentamicin is used for synergy (not aminoglycoside monotherapy) in serious susceptible infections, with vancomycin reserved for appropriate resistant/allergic scenarios.
</Callout>
...
**Prostatitis**: Treat 2–6 weeks; fluoroquinolones have good prostatic penetration but should be culture-reviewed and reserved for appropriate/susceptible cases given HK resistance and FQ safety warnings.
  ...
  items={[
    {
      ...
      markscheme: "First-line: PO nitrofurantoin for 5 days or PO augmentin for 5-7 days (current HK guidance / IMPACT). Levofloxacin is not first-line because HK has 36-46% levofloxacin-resistant E. coli in outpatient urine isolates and fluoroquinolones have potentially disabling adverse effects. Fosfomycin 3 g single dose is an alternative in suitable premenopausal, non-pregnant women.",
    },
    {
    ...
    {
      question: "Why may fluoroquinolones be used for acute prostatitis, and what must be reviewed before continuing them in Hong Kong?",
      markscheme: "The prostate has a blood-prostate barrier with tight epithelial junctions that many antibiotics cross poorly. Fluoroquinolones penetrate prostatic tissue well, so they can be appropriate for acute prostatitis, but cultures, susceptibility, allergy history, contraindications, and fluoroquinolone safety risks must be reviewed. Duration is usually 2-6 weeks. Alternative oral options such as trimethoprim/co-trimoxazole require susceptibility and G6PD review; severe cases need admission and IV therapy before step-down.",
    },
    {
...
[8] Centre for Health Protection / HKMJ: New guidance notes to drive rational prescription of antimicrobials for community settings in Hong Kong (acute uncomplicated cystitis in women; resistance rates and antibiotic choice)
[9] IMPACT 6th edition (2025): Part IV empirical therapy for UTI and Part III fosfomycin trometamol
[10] IMPACT 6th edition (2025): Part III fluoroquinolones safety guidance and general stewardship caveats
