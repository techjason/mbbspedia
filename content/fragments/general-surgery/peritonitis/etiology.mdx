...
<img src="/diagrams/peritoneal-cavity.jpg" alt="Sagittal view of the peritoneal cavity showing parietal peritoneum, visceral peritoneum, and peritoneal cavity" className="max-w-[72px] w-auto h-auto cursor-zoom-in rounded border border-border" />
