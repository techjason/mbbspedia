...
|---|---|---|---|
| ***Atezolizumab + Bevacizumab*** | Anti-PD-L1 + anti-VEGF | **Preferred 1st line** | Current first-line standard for many patients with unresectable/advanced HCC; superior to sorafenib in IMbrave150 |
...
**Practical take-home message** [12][13]: for fit patients with advanced HCC, ***sorafenib is no longer the preferred first-line systemic therapy***. Preferred first-line regimens are now ***atezolizumab + bevacizumab*** or ***durvalumab + tremelimumab***. ***Sorafenib*** and ***lenvatinib*** remain important ***first-line alternatives*** when immunotherapy-based combinations are contraindicated or unsuitable (for example because of bleeding risk, untreated varices, autoimmune disease, or other clinical factors).
...
**Systemic therapy**: Preferred 1st line = ***Atezolizumab + Bevacizumab*** or ***Durvalumab + Tremelimumab***. ***Sorafenib*** / ***Lenvatinib*** remain important ***alternative 1st-line*** options when immunotherapy-based combinations are unsuitable, with later-line therapy chosen according to the prior regimen.
