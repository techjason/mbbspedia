...
```mermaid
flowchart LR
    A["Suspected infection"] --> B["Organ dysfunction?"]
    B -->|"No"| C["Observe and investigate"]
    B -->|"Yes"| D["Sepsis pathway"]
    D --> E["Cultures + lactate"]
    E --> F["Antibiotics"]
    F --> G["Fluids if hypoperfused"]
    G --> H["Norepinephrine if MAP low"]
    H --> I["Source control"]
    I --> J["De-escalate"]
```
