...
```mermaid
flowchart TD
    A["Suspected infection"] --> B["Screen: NEWS2, MEWS, SIRS"]
    ...
    E --> E4["Crystalloid if hypoperfused"]
    E --> E5["Find source"]
    E4 --> F{"MAP < 65 or hypoperfusion persists?"}
    F -->|"Yes"| G["Norepinephrine MAP 65"]
    G --> H["Add vasopressin if needed"]
    H --> I["Add epinephrine or inotrope"]
    E5 --> J{"Source control needed?"}
    J -->|"Yes"| K["Control source within 6h"]
    J -->|"No"| L["Continue reassessment"]
