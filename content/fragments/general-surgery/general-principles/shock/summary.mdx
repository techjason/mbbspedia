...
**Definition**: Shock = life-threatening circulatory failure causing inadequate oxygen delivery, cellular hypoxia, anaerobic metabolism, lactate production, organ dysfunction, and death if not reversed.
...
**Vasopressors**: Norepinephrine is the usual first-line vasopressor for vasodilatory shock. Use it early if hypotension persists despite initial fluid or if fluids are unsafe.
