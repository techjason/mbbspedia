...
#### 2.1 ***Nyhus Classification — historical / exam-slide context only*** [1]
...
10. ***Classification systems***: prioritise ***EHS*** in current Hong Kong practice (Primary/Recurrent + L/M/F + size 1/2/3/x). ***Nyhus*** is older slide/legacy context only [1].
...
<ActiveRecallQuiz
  ...
  items={[
    ...
    {
      question: "Which groin hernia classification should be prioritised in current Hong Kong practice, and how should Nyhus be treated?",
      markscheme: "Prioritise the EHS (European Hernia Society) classification: Primary/Recurrent + Location (L = lateral/indirect, M = medial/direct, F = femoral) + Size (1/2/3/x). Nyhus is an older posterior-approach classification and should be recognised only as legacy or older teaching-slide context, not the routine local working classification."
    },
    {
