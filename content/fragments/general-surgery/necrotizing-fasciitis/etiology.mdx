...
|---|---|---|---|
| ***Following exposure to freshwater, seawater or seafood*** | ***Aeromonas hydrophila, A. caviae; Vibrio vulnificus*** | ***IV levofloxacin + IV amoxicillin-clavulanate*** [6] | Urgent microbiology/ID input; *Aeromonas* may carry chromosomal carbapenemase |
| ***Following cuts/abrasion; recent chickenpox; IVDU; healthy adults*** | ***Group A streptococci; may be polymicrobial depending on wound/context*** | ***IV meropenem + IV/PO linezolid*** [6] | De-escalate when deep tissue cultures identify susceptible GAS or another pathogen |
| ***Following intra-abdominal/gynaecological/perineal surgery*** | ***Polymicrobial: Enterobacteriaceae, streptococci, anaerobes*** | ***IV meropenem + IV/PO linezolid*** [6] | De-escalate once cultures and sensitivities return |

> **Why linezolid?** In high-inoculum GAS infections, many organisms are in stationary phase (Eagle effect) where cell-wall antibiotics are less effective. Linezolid (a protein synthesis inhibitor) directly suppresses production of streptococcal superantigens and exotoxins — it acts as a "toxin shut-off valve." IMPACT 6th edition favours linezolid empirically and notes high local *S. pyogenes* clindamycin resistance [6].
...
<ActiveRecallQuiz
  ...
  items={[
    ...
    },
    {
      ...
      markscheme: "Vibrio vulnificus. First-line: IV levofloxacin + IV amoxicillin-clavulanate, with urgent microbiology/ID input."
    },
    {
...
[6] IMPACT 6th edition (2025): Part IV empirical therapy, necrotising fasciitis
