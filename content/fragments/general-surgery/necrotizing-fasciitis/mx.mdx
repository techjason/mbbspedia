...
graph TD
    ...
    C1 -- "Seawater / freshwater / seafood exposure" --> C2["IV levofloxacin + IV amoxicillin-clavulanate"]
    C1 -- "Cuts / abrasion / chickenpox / IVDU / healthy adult" --> C3["IV meropenem + IV/PO linezolid"]
    C1 -- "Post intra-abdominal / gynaecological / perineal surgery" --> C4["IV meropenem + IV/PO linezolid"]
    C1 -- "Post-trauma suspected gas gangrene" --> C5["IV Augmentin + IV Flagyl"]
    C1 -- "Unknown source / cannot determine" --> C6["Broad-spectrum: IV meropenem + IV/PO linezolid"]
...
|---|---|---|---|
| ***1. Following exposure to freshwater, seawater or seafood*** [4][8] | ***Aeromonas hydrophila, A. caviae; Vibrio vulnificus*** | ***IV levofloxacin + IV amoxicillin-clavulanate*** [8] | Urgent microbiology/ID input; *Aeromonas* may carry chromosomal carbapenemase |
| ***2. Following cuts and abrasion; recent chickenpox; IVDU; healthy adults*** [4][8] | ***Group A streptococci; may be polymicrobial depending on wound/context*** | ***IV meropenem + IV/PO linezolid*** [8] | Linezolid provides toxin suppression; IMPACT notes high local clindamycin resistance in *S. pyogenes* |
| ***3. Following intra-abdominal, gynaecological or perineal surgery*** [4][8] | ***Polymicrobial: Enterobacteriaceae, streptococci, anaerobes*** | ***IV meropenem + IV/PO linezolid*** [8] | De-escalate once deep tissue cultures and sensitivities return |
...
|---|---|---|
| **Penicillin G** | β-lactam → inhibits transpeptidase (PBP) → prevents cell wall synthesis → osmotic lysis of growing bacteria | Highly effective against confirmed susceptible GAS (*S. pyogenes*); may be used after de-escalation with specialist input |
...
| **Clindamycin** | Lincosamide → binds 50S ribosomal subunit → inhibits protein synthesis | Historically used for toxin suppression, but IMPACT 6th notes 50–80% local *S. pyogenes* clindamycin resistance and limited clinical data for resistant strains; linezolid is favoured for empirical toxin suppression [8] |

<Callout title="Why Add a Protein Synthesis Inhibitor?">
In severe GAS or clostridial NF, cell-wall-active antibiotics (penicillin, carbapenems) kill bacteria by preventing cell wall formation. But in high-inoculum infections, many bacteria are in **stationary phase** and not actively dividing — so cell-wall antibiotics are less effective (the "Eagle effect"). Adding a **protein synthesis inhibitor** (linezolid preferred empirically in current IMPACT guidance; clindamycin only when appropriate) directly suppresses the production of **exotoxins and superantigens** that are driving tissue destruction and systemic toxicity. It's not just about killing bacteria — it's about shutting off the toxin factory.
</Callout>
...
**Antibiotic regimens** [4][8]:
- Seawater/seafood → ***IV levofloxacin + IV amoxicillin-clavulanate***
- Cuts/abrasion/healthy adults → ***IV meropenem + IV/PO linezolid*** empirically; de-escalate after deep tissue cultures
- Post-surgical polymicrobial → ***IV meropenem + IV/PO linezolid***
- Gas gangrene → ***Augmentin + Flagyl*** [5]

**Why add linezolid?** Suppresses superantigen and exotoxin production — shuts off the toxin factory, not just kills bacteria. Current HK IMPACT guidance favours linezolid empirically because local *S. pyogenes* clindamycin resistance is high.
...
<ActiveRecallQuiz
  ...
  items={[
    ...
    },
    {
      ...
      markscheme: "IV levofloxacin + IV amoxicillin-clavulanate, with urgent microbiology/ID input. This covers Vibrio vulnificus and Aeromonas species which are the likely causative organisms following exposure to seawater, freshwater or seafood."
    },
    {
      ...
      markscheme: "In high-inoculum GAS infections, many bacteria are in stationary phase where cell-wall antibiotics are less effective (Eagle effect). Linezolid is a protein synthesis inhibitor that directly suppresses production of streptococcal superantigens and exotoxins, acting as a toxin shut-off valve, reducing both local tissue destruction and systemic toxicity. Current IMPACT guidance favours meropenem plus linezolid empirically for many NF presentations, with de-escalation after deep tissue cultures."
    },
    {
...
[8] IMPACT 6th edition (2025): Part IV empirical therapy, skin and soft tissue infections / necrotising fasciitis
