...
**Uncomplicated diverticulitis**: selected mild immunocompetent patients may be observed without antibiotics; if antibiotics are used, cover GN aerobes + anaerobes (HK/IMPACT favours beta-lactam-based regimens such as Augmentin; avoid routine fluoroquinolone/co-trimoxazole-heavy choices). Colonoscopy at 6–8 weeks to exclude CRC.
