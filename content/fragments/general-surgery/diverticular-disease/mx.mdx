...
graph TD
    ...
    E --> E1{"Mild / Stable?"}
    E1 -->|"Yes"| E2["Outpatient: observation\n+/- PO antibiotics if indicated"]
    E1 -->|"No / unable to tolerate PO"| E3["Inpatient: IV antibiotics\n+ source-control assessment"]
...
> ***Treatment is selective: observation may be appropriate for truly mild uncomplicated diverticulitis; antibiotics are used when systemic features, comorbidity, immunosuppression, or local policy favours treatment*** [5][8]

> ***Colonoscopy at 6–8 weeks to rule out malignancy*** [5]

The goal is to identify patients who can be safely observed and to treat infection/source-control problems early when they are present.
...
|---|---|---|
| **Observation without antibiotics** | Reassess within 48–72 h | For carefully selected immunocompetent patients with CT-confirmed uncomplicated disease, no sepsis, reliable follow-up |
| **Amoxicillin-clavulanate** (Augmentin) | Usually 5–7 days; follow local policy | Broad-spectrum: GN aerobes + anaerobes (clavulanate = β-lactamase inhibitor extending amoxicillin's spectrum) |
| **Fluoroquinolone + metronidazole** | If used, shortest effective course | Reserve for situations where beta-lactam options are unsuitable and local susceptibility/patient risks support use; fluoroquinolones carry stewardship and safety concerns [8][9] |

[3]

<Callout title="Evolving Practice — Antibiotics for Uncomplicated Diverticulitis" type="idea">
Recent evidence (AVOD trial 2012, DIABOLO trial 2017) suggests that **antibiotics may NOT be necessary** for truly uncomplicated diverticulitis in immunocompetent patients without systemic signs. Some guidelines now recommend **observation without antibiotics** for mild uncomplicated cases. If antibiotics are used in Hong Kong, favour beta-lactam-based regimens and avoid presenting fluoroquinolone- or co-trimoxazole-heavy regimens as routine first-line options.
</Callout>
...
| **IV antibiotics** | ***Amoxicillin-clavulanate*** or ***piperacillin-tazobactam***; alternative ***cefuroxime + metronidazole***; severe ruptured-colon sepsis may need ***meropenem + metronidazole*** [8] | Aligns with IMPACT community-acquired intra-abdominal infection guidance; add metronidazole in severe infection or suboptimal response because anaerobic resistance to beta-lactams/beta-lactamase inhibitors is increasing |
...
| **Uncomplicated diverticulitis (outpatient)** | Selected mild cases: observation without antibiotics; if antibiotics are indicated, use ***amoxicillin-clavulanate*** or another local-policy beta-lactam-based regimen |
| **Uncomplicated diverticulitis (inpatient)** | ***IV antibiotics*** (amoxicillin-clavulanate or pip-taz; alternative cefuroxime + metronidazole; severe ruptured-colon sepsis: meropenem + metronidazole) + source-control assessment |
...
**Uncomplicated diverticulitis**: selected mild immunocompetent patients may be observed without antibiotics; if antibiotics are used, cover GN aerobes + anaerobes with beta-lactam-based regimens. Colonoscopy at 6–8 weeks to exclude CRC.
...
[8] IMPACT 6th edition (2025): Part IV empirical therapy, community-acquired intra-abdominal and gastrointestinal infections
[9] CHP/HKMJ 2026 antimicrobial guidance notes: fluoroquinolone stewardship and community resistance context
