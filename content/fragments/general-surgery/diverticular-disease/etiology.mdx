...
<div className="not-prose flex w-fit items-start gap-2 [&>figure]:m-0">
  <DiagramCard src="/diagrams/diverticular-disease.webp" alt="Anatomy and pathophysiology overview of diverticular disease showing diverticula, diverticulitis progression, and key complications" caption="Diverticular overview" />
