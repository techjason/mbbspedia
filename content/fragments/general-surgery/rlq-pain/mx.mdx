...
| **Uncomplicated diverticulitis (outpatient)** | Selected mild cases may be observed without antibiotics; if antibiotics are indicated, prefer ***amoxicillin-clavulanate*** or another local-policy beta-lactam-based regimen | Usually 5–7 days if treated; follow local policy |
| **Complicated diverticulitis (inpatient)** | ***Amoxicillin-clavulanate*** or ***piperacillin-tazobactam***; alternative ***cefuroxime + metronidazole***; severe ruptured-colon sepsis may need ***meropenem + metronidazole*** | Guided by source control and clinical response |
...
**Diverticulitis:** Mild uncomplicated disease may be observed without antibiotics; treat systemic/complicated disease with local-policy antibiotics and source control. Abscess > 4–5 cm → percutaneous drainage; Hinchey 3–4 → emergency surgery (Hartmann's or primary anastomosis ± ileostomy). Always colonoscopy at 6 weeks. Recurrent uncomplicated attacks are no longer an indication for interval colectomy.
