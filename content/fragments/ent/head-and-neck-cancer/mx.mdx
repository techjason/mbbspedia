...
The classic framework is the **ladder of reconstruction** [5]. It runs from simple to complex:

**Direct closure → Skin graft → Local flap → Distant / pedicled flap → Free flap**

Think of each rung as adding one extra reconstructive capability:

- **Direct closure** closes a small gap.
- **Skin graft** replaces a surface lining.
- **Local flap** brings nearby vascularised tissue.
- **Distant / pedicled flap** brings larger vascularised tissue from another region while keeping its original blood supply.
- **Free flap** imports specialised tissue, such as skin, fascia, muscle, or bone, using microvascular anastomosis.

The important exam point is that the ladder is a **framework, not a rulebook**. Surgeons usually choose the simplest option that will reliably restore **form and function**, but H&N defects often need an early jump to a higher rung because swallowing, speech, airway protection, dental rehabilitation, and cosmesis all matter. For example, a small mucosal defect may be grafted, but a segmental mandibulectomy cannot be solved by "climbing one rung at a time" — it needs vascularised bone, so the correct answer is usually a **fibula free flap**.

| Rung | What It Means | Best For | H&N Examples | Main Limitation |
|:--|:--|:--|:--|:--|
| **1. Direct / primary closure** | Bring wound edges together directly | Small full-thickness or mucosal defects where closure is tension-free | Small lip wedge excision; small oral tongue defect after wide local excision | Can distort nearby functional units: tongue tethering, microstomia, lip notching, oral incompetence |
| **2. Secondary intention** | Allow granulation and epithelialisation without formal reconstruction | Small superficial mucosal defects where contraction will not impair function | Small tonsillar fossa or superficial oral mucosal defects | Contraction can cause tethering, trismus, poor cosmesis, or swallowing/speech problems |
| **3. Skin graft** | Thin sheet of skin placed onto a vascular bed; usually split-thickness skin graft | Replacing surface lining when no bulk is needed | Superficial floor-of-mouth or buccal mucosal defects after excision | Needs a well-vascularised bed; cannot cover exposed bare bone, cartilage, tendon, or major vessels; contracts and provides little bulk |
| **4. Local flap** | Nearby tissue rotated, advanced, or transposed into the defect while keeping its own blood supply | Small-to-moderate defects where adjacent tissue has similar colour, texture, and thickness | Lip reconstruction with Abbe / Estlander flap; local mucosal advancement flap; small cheek or oral defects | Limited reach and volume; may distort neighbouring structures |
| **5. Regional / distant pedicled flap** | Tissue moved from a nearby region while still attached to its vascular pedicle | Larger defects when reliable vascularised tissue is needed, especially if microvascular surgery is unsuitable | Pectoralis major myocutaneous flap for pharyngeal or neck defects; deltopectoral flap for skin/neck coverage | Bulkier and less precise than free tissue transfer; donor-site morbidity; reach may be limited |
| **6. Free flap** | Tissue completely detached and reattached using microvascular anastomosis | Complex composite defects needing tailored tissue: thin lining, bulk, muscle, or bone | ***Soft pliable fasciocutaneous free flaps can provide intraoral bulk and preservation of tongue mobility*** [2] (e.g., radial forearm, ALT); fibula free flap for mandibular reconstruction | Most complex; requires suitable vessels, longer operating time, and flap monitoring |

**How to understand the rungs clinically**:

- **Rung 1: Can I simply close it?** If yes, primary closure is fastest and avoids donor-site morbidity. But in H&N, "can close" is not enough — the closure must not impair tongue mobility, lip competence, mouth opening, or airway calibre.
- **Rung 2: Can I safely let it heal?** Secondary intention is reasonable only when contraction will not matter. It is less attractive around mobile functional structures because scar contraction can tether the tongue or narrow the oral cavity.
- **Rung 3: Is only a lining defect missing?** Skin grafts are thin and useful for surface replacement, but they do not bring their own blood supply or bulk. They fail on poorly vascularised beds and are poor for dead space.
- **Rung 4: Can nearby like-with-like tissue reach?** Local flaps are excellent for lips, cheeks, nose, and small oral defects because adjacent tissue matches well. The price is local distortion if the flap is too tight or too large.
- **Rung 5: Do I need robust vascularised tissue without microvascular complexity?** Pedicled flaps, especially the pectoralis major flap, are workhorse options for high-risk patients, vessel-depleted necks, salvage surgery after RT, and pharyngeal reinforcement.
- **Rung 6: Do I need specialised tissue to rebuild function?** Free flaps are often the best answer for major H&N defects: radial forearm for thin pliable lining, ALT for soft-tissue bulk, fibula for mandible, and jejunal / fasciocutaneous flaps for selected pharyngeal defects.

<Callout title="How To Choose The Rung" type="idea">
In H&N cancer, the question is not simply "what is the smallest defect?" It is: **what tissue is missing, and what function must be restored?** A small superficial mucosal defect may be closed or grafted. A mobile tongue defect needs thin pliable tissue to preserve speech and swallowing. A segmental mandibulectomy needs vascularised bone to restore mandibular continuity, dental rehabilitation, and facial contour. A pharyngeal defect needs watertight vascularised tissue to separate the aerodigestive tract from the neck.
</Callout>

**Common H&N reconstruction choices by defect**:

| Defect | Typical Reconstruction | Why |
|:--|:--|:--|
| Small lip / tongue mucosal defect | Direct closure | Fastest and simplest if it does not distort function |
| Superficial floor-of-mouth defect | Split-thickness skin graft | Thin lining replacement is enough if the bed is vascular |
| Partial glossectomy | Radial forearm or anterolateral thigh (ALT) free flap | Provides soft pliable tissue and bulk to restore tongue-palate contact |
| Segmental mandibulectomy | Fibula free flap | Provides vascularised bone, allows mandibular contour and later dental implants |
| Pharyngeal / laryngopharyngeal defect | Pectoralis major flap or free flap | Provides vascularised tissue to close the pharynx and reduce fistula risk |
| Palatal defect | Obturator / dental prosthesis or flap reconstruction | Separates oral and nasal cavities to restore speech and swallowing |

***Dental prosthesis***: ***Through-and-through defects of palate require dental prosthesis for rehabilitation of swallowing and speech*** [2]. Obturators are especially useful for palatal defects.
