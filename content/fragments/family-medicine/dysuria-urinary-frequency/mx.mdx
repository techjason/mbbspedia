...
graph TD
    ...
    C1 -->|"Uncomplicated"| C2["Short-course oral Abx:<br/>nitrofurantoin 5d<br/>or Augmentin 5-7d"]
  ...
  items={[
    {
      ...
      markscheme: "Acute uncomplicated cystitis. First-line in HK: nitrofurantoin for 5 days or amoxicillin-clavulanate for 5-7 days. Fosfomycin 3 g single dose is an alternative for suitable premenopausal, non-pregnant women. Avoid fluoroquinolones empirically due to 36-46% local E. coli levofloxacin resistance and adverse-effect concerns. Must check G6PD status before prescribing nitrofurantoin or co-trimoxazole (prevalence ~4.5% in HK males)."
    },
    {
...
[6] Centre for Health Protection / HKMJ: Antibiotic Guidance Notes in Community Setting - Acute uncomplicated cystitis in women (Dec 2025 version; local resistance rates and recommended antibiotic table)
[7] IMPACT 6th edition (2025): empirical therapy for UTI and fosfomycin trometamol guidance
