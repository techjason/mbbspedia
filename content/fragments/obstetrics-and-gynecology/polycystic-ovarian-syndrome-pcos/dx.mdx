## Diagnostic Criteria, Algorithm, and Investigations for PCOS

---

### 1. Diagnostic Criteria

#### 1.1 The Rotterdam Criteria (2003, reaffirmed 2018 International PCOS Guideline)

This is the most widely used and the standard taught at HKUMed. The diagnosis requires **2 out of 3** criteria, **after exclusion of other aetiologies** [1][12]:

> ***Two out of the three criteria (Rotterdam consensus):***
> 1. ***Oligo-anovulation***
> 2. ***Clinical / biochemical hyperandrogenism***
> 3. ***Sonographic features of polycystic ovaries (Follicle number per ovary of > 20 and/or an ovarian volume ≥ 10 mL)*** [1][12]
...
In adolescents (< 8 years post-menarche), physiological oligo-anovulation is common as the HPO axis matures. The 2018 International PCOS Guideline recommends **caution** in diagnosing PCOS in adolescents — both hyperandrogenism AND oligo-anovulation should be present (i.e., a stricter threshold). Ultrasound criteria for PCOM should NOT be used in adolescents within 8 years of menarche due to high prevalence of multifollicular ovaries as a normal variant.
</Callout>
...
- ***Follicle number per ovary (FNPO) of > 20*** — using modern transvaginal ultrasound probes (≥ 8 MHz). The original 2003 threshold was > 12, but with improved ultrasound resolution, more follicles are detected in normal women, so the threshold was raised to > 20 in the **2018 International PCOS Guideline**.
...
The 2018 guideline acknowledges that **serum AMH** can be used as an alternative to ultrasound for PCOM in adults (not adolescents) when USS is not available or feasible. AMH is produced by granulosa cells of small antral follicles — elevated AMH (typically > 35 pmol/L or > 5 ng/mL, though no universally agreed threshold yet) reflects the increased follicle count. AMH has the advantages of being:
- Not affected by the day of the cycle.
- Not operator-dependent.
- Useful when USS is not possible.

However, AMH is **not yet formally part of the Rotterdam criteria** and assay standardisation is still evolving. It is increasingly used in clinical practice, especially in fertility clinics.

---

#### 1.2 Comparison of Diagnostic Criteria Across Guidelines

| Feature | NIH 1990 | Rotterdam 2003 | AE-PCOS Society 2006 | 2018 International Guideline |
|---|---|---|---|---|
| Hyperandrogenism | Required | 2 of 3 | Required | 2 of 3 (reaffirms Rotterdam) |
| Oligo-anovulation | Required | 2 of 3 | Either OA or PCOM | 2 of 3 |
| PCOM on USS | Not included | 2 of 3 | Either OA or PCOM | 2 of 3 (updated USS threshold: FNPO > 20) |
| Exclusion of other causes | Yes | Yes | Yes | Yes |
| AMH as alternative to USS | No | No | No | Acknowledged but not formally required |
| Adolescent modifications | No | No | No | Yes — stricter criteria (require HA + OA) |

<Callout title="For Exams: Use Rotterdam" type="idea">
The Rotterdam criteria are what is taught in the HKUMed lecture slides [1][12] and are the international standard. For exam purposes, always state: "PCOS is diagnosed by 2 out of 3 Rotterdam criteria after exclusion of other aetiologies."
</Callout>
...
2. **Confirm ≥ 2 of 3 Rotterdam criteria**
...
graph TD
    ...
    N --> O{"Assess PCOM:<br/>FNPO > 20 and/or<br/>ovarian volume ≥ 10 mL?"}
    O -->|"Yes"| P["PCOM criterion met"]
    O -->|"No"| Q["PCOM criterion not met"]

    P --> R["Step 4: Apply Rotterdam Criteria<br/>— ≥ 2 of 3 met?"]
    Q --> R
    H --> R
    R -->|"Yes — after excluding other causes"| S["PCOS CONFIRMED"]
...
|---|---|---|
| ***Follicle number per ovary (FNPO)*** | ***> 20*** [1][12] (per ovary, using TVS with ≥ 8 MHz probe) | Count follicles 2–9 mm in both longitudinal and transverse planes. The original 2003 threshold was > 12, but the 2018 guideline raised this to > 20 to account for improved ultrasound technology detecting more follicles. |
...
| **Fasting insulin (± HOMA-IR)** | Insulin resistance | Fasting insulin often > 60 pmol/L. HOMA-IR = (fasting glucose × fasting insulin) / 22.5. Values > 2.5 suggest insulin resistance. Note: fasting insulin is NOT routinely recommended in the 2018 guideline due to poor standardisation, but is used in some centres. | Not routine |
...
In PCOS, insulin resistance preferentially affects post-prandial glucose handling. Many women will have a normal fasting glucose but an abnormal 2-hour post-load glucose on OGTT. Using fasting glucose or HbA1c alone will **miss up to 40% of women with IGT or T2DM**. The 2018 International PCOS Guideline recommends OGTT as the gold standard for metabolic screening in PCOS.
</Callout>
...
**Diagnostic Criteria:** ***Rotterdam Consensus — 2 out of 3, after excluding other causes:*** [1][12]
1. ***Oligo-anovulation***
2. ***Clinical / biochemical hyperandrogenism***
3. ***Sonographic features of polycystic ovaries (FNPO > 20 and/or ovarian volume ≥ 10 mL)***
...
**Key hormonal pattern in PCOS:** ↑LH, normal/↓FSH, LH:FSH > 2, mildly ↑testosterone, ↓SHBG, ↑FAI, ↑AMH

**USS criteria (2018):** FNPO > 20 and/or ovarian volume ≥ 10 mL (updated from > 12 due to improved ultrasound resolution)

**Metabolic screening in ALL PCOS patients:** OGTT (preferred over fasting glucose alone), fasting lipids, BP, BMI, waist circumference, LFTs

***High FSH ( > 25 IU/L) indicates ovarian insufficiency — NOT PCOS*** [2][4][14]

**Adolescent caution:** Do not use PCOM on USS for diagnosis < 8 years post-menarche; require both HA + OA
...
<ActiveRecallQuiz
  ...
  items={[
    {
      question: "State the Rotterdam diagnostic criteria for PCOS, including the updated 2018 USS threshold. What must be done before applying these criteria?",
      markscheme: "2 out of 3: (1) Oligo-anovulation, (2) Clinical or biochemical hyperandrogenism, (3) Polycystic ovarian morphology on USS — FNPO >20 and/or ovarian volume >=10 mL. Must exclude other causes first (diagnosis of exclusion): pregnancy, thyroid disorders, hyperprolactinaemia, non-classic CAH, Cushing's syndrome, androgen-secreting tumours.",
    },
    {
    ...
    },
    {
      ...
      markscheme: "No. In adolescents less than 8 years post-menarche, USS criteria for PCOM should NOT be used because multifollicular ovaries are a normal developmental variant. The 2018 guideline recommends stricter criteria in adolescents: both hyperandrogenism AND oligo-anovulation must be present. Mild acne alone is insufficient for clinical hyperandrogenism in a teenager. Reassess after 8 years post-menarche.",
    },
    {
