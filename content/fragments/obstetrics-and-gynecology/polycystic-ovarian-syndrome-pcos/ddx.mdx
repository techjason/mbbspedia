...
graph TD
    ...
    Q --> R["Apply PMOS/PCOS criteria"]
    R --> S["PMOS/PCOS — diagnosis of exclusion confirmed"]
```

---

### Key Distinguishing Features: PMOS/PCOS vs. Main Differentials
...
<Callout title="Rapid Virilisation = NOT PMOS/PCOS" type="error">
