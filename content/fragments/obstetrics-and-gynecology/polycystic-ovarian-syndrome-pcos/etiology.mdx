...
> 3. ***Polycystic ovarian morphology on ultrasound (FNPO > 20 and/or ovarian volume ≥ 10 mL) OR elevated AMH in adults*** [1][8]
...
<ActiveRecallQuiz
  ...
  items={[
    {
      question: "State the current adult diagnostic criteria for PMOS/PCOS. How many criteria are needed?",
      markscheme: "2 out of 3 required: (1) Oligo-anovulation, (2) Clinical or biochemical hyperandrogenism, (3) Polycystic ovarian morphology on USS (FNPO >20 and/or ovarian volume >=10 mL) or elevated AMH in adults. Must exclude other causes (diagnosis of exclusion).",
    },
    {
...
[8] Teede HJ, et al. Recommendations from the 2023 International Evidence-based Guideline for the Assessment and Management of Polycystic Ovary Syndrome. Fertility and Sterility. 2023.
[9] Teede HJ, et al. Polyendocrine metabolic ovarian syndrome, the new name for polycystic ovary syndrome: a multistep global consensus process. Lancet. 2026.
[10] Endocrine Society. Polyendocrine Metabolic Ovarian Syndrome: New name to improve diagnosis and care. 2026.
