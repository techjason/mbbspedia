...
***PPH is defined as blood loss > 500 mL in vaginal delivery or > 500 mL in Caesarean delivery (new guidelines).*** [1][2]

***For clinical purposes, even if the estimated blood loss is less than 500 mL, treatment should be initiated if the patient has symptoms or signs of shock.*** [3][4]
...
```mermaid
graph TD
    A["PPH Recognised: Blood Loss > 500 mL OR Signs of Shock"] --> B["SIMULTANEOUS: Resuscitate + Investigate"]
...
**PPH is a clinical diagnosis** — defined by blood loss > 500 mL (both VD and CS by new guidelines) OR presence of haemodynamic compromise regardless of measured loss.
